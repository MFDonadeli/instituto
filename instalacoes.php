...
<p>Sendo assim, conheça melhor os serviços que o Instituto Paulista pode lhe oferecer.</p>
                    ...
                    <div id="gallery">
                        <div class="item">
                            <a href="#img1">
                                <img src="images/foto1.jpg" alt="Nossas Instalações" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#img2">
                                <img src="images/foto2.jpg" alt="Nossas Instalações" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#img3">
                                <img src="images/foto3.jpg"  alt="Nossas Instalações" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#img4">
                                <img src="images/foto4.jpg"  alt="Nossas Instalações" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#img5">
                                <img src="images/foto5.jpg"  alt="Nossas Instalações" />
                            </a>
                        </div>
                        <div class="item">
                            <a href="#img6">
                                <img src="images/foto6.jpg"  alt="Nossas Instalações" />
                            </a>
                        </div>
                    </div> <!-- gallery -->
