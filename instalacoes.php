...
<p>Sendo assim, conheça melhor os serviços que o Instituto Paulista pode lhe oferecer.</p>
                    ...
                    <div class="lightbox" id="img6">
                        <div class="box">
                            <a class="close" href="#">X</a>
                            <div class="content">
                                <embed src="http://www.institutopaulista.org/swf/videoInstituto.swf">
                            </div>
                        </div>
                    </div>
                  </div>
